...
<div class="form-bottom">
                               <form role="form" action="" method="post" class="exim_form" id="exim_form" >
                                  <div class="form-group2">
                                   <div><label>Specify the Product tange you cater to</div>
                         ...
                         ?>
                          ...
                          <input type="text" id="other_service_country2" class="other_service_country2" placeholder="Enter Your Country If Others" disabled >
                            </div>
                            <div class="form-group2">
